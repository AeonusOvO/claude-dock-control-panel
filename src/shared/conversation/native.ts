...
export interface NativeAttachmentImportResult extends FailureMetadata {
...
export interface NativeConversationStartResult extends FailureMetadata {
  conversationId: string;
...
export interface NativeConversationOperationResult extends FailureMetadata {
  message?: string;
  ok: boolean;
