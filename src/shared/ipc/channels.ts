const requestChannels = {
  ...
  APP_SET_CONVERSATION_RESUME_PREFERENCES: 'app:set-conversation-resume-preferences',
  ...
  CLAUDE_CONVERSATION_MODEL_APPLY: 'claude:conversation-model-apply',
  CLAUDE_CONVERSATION_MODEL_INSPECT: 'claude:conversation-model-inspect',
